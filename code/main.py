...
tf.app.flags.DEFINE_integer("batch_size", 101, "Batch size to use")
tf.app.flags.DEFINE_integer("hidden_size", 200, "Size of the hidden states")
tf.app.flags.DEFINE_integer("context_len", 500, "The maximum context length of your model")
tf.app.flags.DEFINE_integer("question_len", 40, "The maximum question length of your model")
...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with tf.Session(config=config) as sess:
            ...
            _, _ = qa_model.check_f1_em(sess, dev_context_path, dev_qn_path, dev_ans_path, "dev", num_samples=12000, print_to_screen=False)
